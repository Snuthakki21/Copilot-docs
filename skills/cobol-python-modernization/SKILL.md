...
| Claiming 100% because tests pass | Require provenance, documented functions, full rule traceability, ≥80% coverage, and zero migration mismatches. |
